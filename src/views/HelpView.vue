  ...
  <div class="help-view" :class="{ embedded }">
    ...
    <el-collapse v-model="activeSections">
      ...
      <el-collapse-item title="五、后端部署（重点）" name="backend">
        <div class="help-body">
          ...
          <ul>
            ...
            <li>出问题到「发布历史」点<b>回滚</b>，一键恢复替换前的 bin。</li>
          </ul>
      ...
      <el-collapse-item title="六、前端部署 / Docker 部署" name="frontend">
        <div class="help-body">
          <ul>
            <li><b>前端部署</b>：本地 dist 和服务器目录逐文件对比，只传有变化的文件。同样支持「仅上传到中转」和「从中转替换」，以及替换前日期备份。中转目录默认是 <code>目录名-staging</code>，也可以在「编辑」里自定义到任意位置。</li>
